...
`,n=new Blob([t],{type:"text/markdown;charset=utf-8"}),S=URL.createObjectURL(n),P=document.createElement("a");P.href=S,P.download=`integration-guide-key-${l.id}.md`,P.click(),URL.revokeObjectURL(S),s.notify({type:"positive",message:"Integration Guide exported!"})}return Z(()=>{r.fetchKeys()}),(l,e)=>(u(),g(le,{padding:""},{default:i(()=>[o("div",se,[o("div",re,[e[7]||(e[7]=o("div",null,[o("h1",null,"Key Management"),o("p",null,"Manage RSA-2048 key pairs for license signing")],-1)),a(d,{color:"primary",icon:"add",label:"Generate New Key Pair",onClick:e[0]||(e[0]=t=>c.value=!0),loading:f(r).loading},null,8,["loading"])])]),f(r).keys.length===0&&!f(r).loading?(u(),$("div",de,[a(v,{name:"vpn_key_off"}),e[8]||(e[8]=o("h3",null,"No Key Pair Generated",-1)),e[9]||(e[9]=o("p",null,"Generate an RSA-2048 key pair to start issuing licenses",-1)),a(d,{color:"primary",icon:"add",label:"Generate Key Pair",onClick:e[1]||(e[1]=t=>c.value=!0),class:"q-mt-md"})])):R("",!0),f(r).keys.length>0?(u(),g(K,{key:1,class:"q-mt-lg"},{default:i(()=>[a(b,null,{default:i(()=>[...e[10]||(e[10]=[o("div",{class:"text-h6"},"All Key Pairs",-1)])]),_:1}),a(ie,{rows:f(r).keys,columns:N,"row-key":"id",flat:"",loading:f(r).loading,"rows-per-page-options":[10,20,50]},{header:i(t=>[a(L,{props:t},{default:i(()=>[a(O,{"auto-width":""}),(u(!0),$(D,null,Q(t.cols,n=>(u(),g(O,{key:n.name,props:t},{default:i(()=>[y(m(n.label),1)]),_:2},1032,["props"]))),128))]),_:2},1032,["props"])]),body:i(t=>[a(L,{props:t,class:"cursor-pointer",onClick:n=>t.expand=!t.expand},{default:i(()=>[a(E,{"auto-width":""},{default:i(()=>[a(d,{size:"sm",color:"primary",round:"",dense:"",outline:"",onClick:T(n=>t.expand=!t.expand,["stop"]),icon:t.expand?"remove":"add"},null,8,["onClick","icon"])]),_:2},1024),(u(!0),$(D,null,Q(t.cols,n=>(u(),g(E,{key:n.name,props:t},{default:i(()=>[n.name==="actions"?(u(),g(d,{key:0,flat:"",round:"",size:"sm",icon:"delete",color:"negative",onClick:T(S=>z(t.row),["stop"])},null,8,["onClick"])):(u(),$(D,{key:1},[y(m(n.value),1)],64))]),_:2},1032,["props"]))),128))]),_:2},1032,["props","onClick"]),ee(a(L,{props:t},{default:i(()=>[a(E,{colspan:"100%",class:"bg-grey-1"},{default:i(()=>[o("div",ce,[o("div",ue,[e[11]||(e[11]=o("div",{class:"text-subtitle2 text-grey-8 q-mb-sm"},"Public Key",-1)),o("div",ye,m(t.row.public_key),1),a(d,{size:"sm",color:"primary",outline:"",icon:"content_copy",label:"Copy Public Key",onClick:n=>V(t.row.public_key),class:"q-mt-sm"},null,8,["onClick"]),a(d,{size:"sm",color:"secondary",outline:"",icon:"download",label:"Export Guide (.md)",onClick:n=>M(t.row),class:"q-mt-sm q-ml-sm"},null,8,["onClick"])]),o("div",pe,[e[14]||(e[14]=o("div",{class:"text-subtitle2 text-grey-8 q-mb-sm"},"Details",-1)),a(oe,{dense:""},{default:i(()=>[a(q,null,{default:i(()=>[a(x,null,{default:i(()=>[...e[12]||(e[12]=[y("Private Key Hash",-1)])]),_:1}),a(x,{side:"",class:"text-caption",style:{"font-family":"monospace"}},{default:i(()=>[y(m((t.row.private_key_hash||"").substring(0,16))+"... ",1)]),_:2},1024)]),_:2},1024),a(q,null,{default:i(()=>[a(x,null,{default:i(()=>[...e[13]||(e[13]=[y("Created By",-1)])]),_:1}),a(x,{side:""},{default:i(()=>[y(m(t.row.created_by),1)]),_:2},1024)]),_:2},1024)]),_:2},1024)])])]),_:2},1024)]),_:2},1032,["props"]),[[te,t.expand]])]),_:1},8,["rows","loading"])]),_:1})):R("",!0),a(A,{modelValue:c.value,"onUpdate:modelValue":e[4]||(e[4]=t=>c.value=t),persistent:""},{default:i(()=>[a(K,{style:{"min-width":"450px"}},{default:i(()=>[a(b,{class:"row items-center"},{default:i(()=>[a(v,{name:"vpn_key",color:"primary",size:"md",class:"q-mr-sm"}),e[15]||(e[15]=o("div",{class:"text-h6"},"Generate New Key Pair",-1))]),_:1}),a(b,null,{default:i(()=>[a(H,{class:"bg-warning text-dark q-mb-md rounded-borders",dense:""},{avatar:i(()=>[a(v,{name:"warning"})]),default:i(()=>[e[16]||(e[16]=y(" You are generating a new RSA key pair. Old keys will remain active and you can choose which key to sign new licenses with later. ",-1))]),_:1}),a(ae,{modelValue:w.value,"onUpdate:modelValue":e[2]||(e[2]=t=>w.value=t),label:"Key Name",hint:"A friendly name for this key pair",outlined:"",class:"q-mb-md"},null,8,["modelValue"])]),_:1}),a(G,{align:"right"},{default:i(()=>[a(d,{flat:"",label:"Cancel",onClick:e[3]||(e[3]=t=>c.value=!1)}),a(d,{color:"primary",label:"Generate",icon:"vpn_key",onClick:U,loading:C.value},null,8,["loading"])]),_:1})]),_:1})]),_:1},8,["modelValue"]),a(A,{modelValue:h.value,"onUpdate:modelValue":e[6]||(e[6]=t=>h.value=t),persistent:""},{default:i(()=>[a(K,{style:{"min-width":"800px","max-width":"95vw"}},{default:i(()=>[a(b,{class:"row items-center bg-positive text-white"},{default:i(()=>[a(v,{name:"check_circle",size:"md",class:"q-mr-sm"}),e[17]||(e[17]=o("div",{class:"text-h6"},"Key Pair Generated Successfully!",-1))]),_:1}),a(b,null,{default:i(()=>{var t,n;return[a(H,{class:"bg-red-1 text-red-9 q-mb-md rounded-borders",dense:""},{avatar:i(()=>[a(v,{name:"error",color:"red"})]),default:i(()=>[e[18]||(e[18]=o("strong",null,"IMPORTANT:",-1)),e[19]||(e[19]=y(" Download the private key NOW. It cannot be retrieved later! ",-1))]),_:1}),o("div",me,[o("div",_e,[e[20]||(e[20]=o("div",{class:"text-subtitle2 q-mb-xs"},"Public Key",-1)),o("div",fe,m((t=p.value)==null?void 0:t.public_key),1)]),o("div",ge,[e[21]||(e[21]=o("div",{class:"text-subtitle2 q-mb-xs"},"Private Key (KEEP SECRET!)",-1)),o("div",ve,m((n=p.value)==null?void 0:n.private_key),1)])])]}),_:1}),a(G,{align:"right"},{default:i(()=>[a(d,{color:"primary",icon:"download",label:"Download Private Key",onClick:B}),a(d,{color:"secondary",icon:"content_copy",label:"Copy Public Key",onClick:j}),a(d,{flat:"",label:"Close",onClick:e[5]||(e[5]=t=>h.value=!1)})]),_:1})]),_:1})]),_:1},8,["modelValue"])]),_:1}))}};export{De as default};
